				...
				<div slot="body">
					<div class="row py-2 ">
						<div class="col-sm-12 col-md-12 col-lg-12  text-center align-self-center form-group">
							...
							<div class="col-md-12">
								<input type="text" class="form-control" v-model="new_services.title">
							</div>
							<label class="control-label">New description:</label>
							<div class="col-md-12">
								<input type="text" class="form-control" v-model="new_services.description">
							</div>
							<label class="control-label">Button Name:</label>
							<div class="col-md-12">
								<input type="text" class="form-control" v-model="new_services.button">
							</div>
						</div>
					</div>
	...
	export default{
		...
		methods:{
			save(){
				var test={};
				test.id=Math.random();
				test.title=this.new_services.title;
				test.description=this.new_services.description;
				test.button=this.new_services.button;
				test.img=this.image;
				var ultimoindex='';
